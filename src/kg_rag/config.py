...
class RagConfig:
    ...
    def from_env(cls) -> "RagConfig":
        return cls(
            ...
            query_top_k=_get_int("QUERY_TOP_K", 60),
            ...
            max_context_tokens=_get_int("MAX_CONTEXT_TOKENS", 24000),
            entity_max_tokens=_get_int("ENTITY_MAX_TOKENS", 1200),
            answer_max_tokens=_get_int("ANSWER_MAX_TOKENS", 3000),
            reranker_enabled=_get_bool("RERANKER_ENABLED", True),
            reranker_model=os.getenv("RERANKER_MODEL", "BAAI/bge-reranker-base"),
            reranker_top_k=_get_int("RERANKER_TOP_K", 20),
            per_doc_chunk_limit=_get_int("PER_DOC_CHUNK_LIMIT", 5),
